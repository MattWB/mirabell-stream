  ...
  return (
    <header className="sticky top-0 z-50 border-b border-sidebar-border bg-sidebar md:hidden">
      <div className="flex h-14 items-center justify-between px-4">
        ...
        <button
          className="grid size-10 place-items-center rounded-md text-white/65 transition-colors hover:bg-white/5 hover:text-white"
          type="button"
      ...
      {isMenuOpen && (
        <AdminNavigation
          className="max-h-[calc(100vh-3.5rem)] overflow-y-auto border-t border-sidebar-border"
